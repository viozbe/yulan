...
<el-card class="centerCard">
 <el-dialog
  ...
  width="1300px">
  <!-- <span>此功能暂时还有点问题，等处理完问题再上传</span> -->
  <keep-alive>
    <detailCurtainTable
      v-if="detailVisible"
  ...
  <div slot="header">
    ...
    <el-button @click.native="closeToTab({oldUrl:'order/examineDetail',newUrl:'order/examine'})" style="float:right;" size="small"  type="success" plain>返回</el-button>
 </div>
