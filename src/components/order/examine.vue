...
<el-card class="centerCard">
  <div>  
    <el-date-picker type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd"  placeholder="日期区间" v-model="date1" style="width:14%;"></el-date-picker>--
    <el-date-picker type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="日期区间" v-model="date2" style="width:14%;"></el-date-picker>
    <el-select v-model="orderType" placeholder="请选择订单状态">
      <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
      </el-option>
    </el-select>
    <el-input @keyup.enter.native="search()" placeholder="请输入相关信息搜索订单" v-model="find" style="width:300px;">  
  ...
  <div id="outDiv">
    <el-card  v-for="(item,index) of data" :key="index">
        ...
        <div class="buttonDiv">
            ...
            <p><el-button v-if="item.CURTAIN_STATUS_ID=='0'||item.CURTAIN_STATUS_ID=='3'"  @click="toExamineDetail(item.ORDER_NO)" size="medium" type="success" plain>审核订单</el-button></p>   
            <p><el-button @click="toCheckExamine(item.ORDER_NO)" size="medium" type="primary" plain>订单详情</el-button></p>   
        </div>
    </el-card>
