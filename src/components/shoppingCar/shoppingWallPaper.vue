    ...
    methods: {
        ...
        squareChange(value, index, groupIndex,flag){
            ...
            if(selected === true){
                ...
                if(this.multipleSelection[i].quantity)
                    ...
                    let sub =  this.subtotal(_data.width, _data.height, this.multipleSelection[i].price)
                    total += sub
                }
        ...
        numberChange(value, index, groupIndex) {
            ...
            if(selected === true){
                ...
                let _data = this.shopsData[groupIndex].commodities[index];
                if(this.multipleSelection[i].quantity)
                    total += parseFloat(this.multipleSelection[i].price * this.shopsData[groupIndex].commodities[index].quantity);
                else{
                    let sub = this.subtotal(_data.width, _data.height, this.multipleSelection[i].price)
                    total += sub;
                }
