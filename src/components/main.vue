        ...
        <el-container class="page">
                ...
                <el-scrollbar style="height:100%;">
                    ...
                    <el-menu 
                        ...
                        <el-submenu index="shops">
                            <template slot="title"><i class="iconfont icon-color">&#xe624;</i><span>产品</span></template>
                            <el-menu-item-group>
                                <router-link to="/shops/wallPaper" tag="div">
                                    <el-menu-item index="shops/wallPaper"><span>墙纸配套类</span></el-menu-item>
                                </router-link>
                                <router-link to="/shops/curtain" tag="div">
                                    <el-menu-item index="shops/curtain"><span>窗帘</span></el-menu-item>
                                </router-link>
                                <router-link to="/shops/softSuit" tag="div">
                                    <el-menu-item index="shops/softSuit"><span>软装</span></el-menu-item>
                                </router-link>
                            </el-menu-item-group>
                        </el-submenu>
                        <el-submenu index="shoppingCar">
                            <template slot="title"><i class="iconfont icon-color">&#xf0179;</i><span>购物车</span></template>
                            <el-menu-item-group>
                                <router-link to="/shoppingCar/shopping?wallPaper" tag="div">
                                    <el-menu-item index="shoppingCar/shopping?wallPaper"><span>墙纸配套类</span></el-menu-item>
                                </router-link>
                                <router-link to="/shoppingCar/shopping?curtain" tag="div">
                                    <el-menu-item index="shoppingCar/shopping?curtain"><span>窗帘</span></el-menu-item>
                                </router-link>
                                <router-link to="/shoppingCar/shopping?softSuit" tag="div">
                                    <el-menu-item index="shoppingCar/shopping?softSuit"><span>软装</span></el-menu-item>
                                </router-link>
                            </el-menu-item-group>
                        </el-submenu>
                        ...
                        <router-link to="/refundCompensation" tag="div">
                            <el-menu-item v-if="identity === 'ECWEB'||identity === 'USER'" index="refundCompensation">
                                <i class="iconfont icon-color">&#xe6ee;</i>
                        ...
                        <el-submenu index="design">
                            ...
                            <el-menu-item-group>
                                <router-link to="/design/imageShop" tag="div">
                                    <el-menu-item index="design/imageShop"><span>形象店设计</span></el-menu-item>
                                </router-link>
                                <router-link to="/design/lanJu" tag="div">
                                    <el-menu-item index="design/lanJu"><span>兰居设计</span></el-menu-item>
                                </router-link>
                            </el-menu-item-group>
                        </el-submenu>
            ...
            <el-container style="width:85%; min-width:1050px;">
                <el-header height="50px">
                    ...
                    <span v-if="isManager !== '1'" style="color:white;line-height:50px;font-size:12px;">
                        {{'账户：'+cid+' '+realName+' '+'操作员'}}
                    </span>
                    <span v-else style="color:white;line-height:50px;font-size:12px;">
                        {{'账户：'+cid+' '+realName+' '+'管理员'}}
                    </span>
                </el-header>
                <el-main style="margin:0;padding:0;background:#ECF5EF;">
                    <el-tabs 
                        ...
                        <div id="notice">
                            ...
                            <span>{{adminText}}</span>
                            <span class="r f14 mr10" style="line-height:30px;color:red;"><strong><i>{{moneySituation}}</i></strong></span>
                        </div>
                        <el-tab-pane
...
export default {
    ...
    beforeCreate(){
        ...
        if(Cookies.get('customerType') === null || Cookies.get('customerType') === undefined){
